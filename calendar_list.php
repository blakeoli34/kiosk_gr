...
<body>
  <div class="page2">
	...
	<div class="breadcrumbs">
		<a href="index.php">HOME</a> > <a href="calendar_day.php">EVENTS</a> > <a class="active" href="calendar_list.php">ATHLETIC EVENTS</a>
	</div>	
	<div class="row">
	...
	<div class="row">
		<div class="topfilters">
			<ul class="cal_filter">
				...
				<a href="calendar_list.php" class="active"><li>List</li></a>
			</ul>
		</div>
	</div>
	<div class="row">
